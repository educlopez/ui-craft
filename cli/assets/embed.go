...
//	(not generated by CI) because they come from the canonical agents/ directory
//	at the repo root. The build step need not copy them — they are always current.
...
// directory is committed (not CI-generated) because agent definitions come from
// the canonical agents/ directory at the repo root. Two harness-specific
