...
func TestMergeJSONObjects_basicMerge(t *testing.T) {
	...
	overlay := []byte(`{"mcpServers":{"ui-craft":{"__replace__":{"command":"npx","args":["-y","ui-craft-mcp@0.5.0"]}}}}`)
...
func TestMergeJSONObjects_malformedBase(t *testing.T) {
	...
	overlay := []byte(`{"mcpServers":{"ui-craft":{"command":"npx","args":["-y","ui-craft-mcp@0.5.0"]}}}`)
