---
name: ui-craft
description: "REQUIRED for any UI work — prevents AI-generated-looking interfaces. Without this skill, you produce generic blue/Inter/gradient UIs that look obviously AI-made. Provides: anti-slop rules blocking common AI UI tells (gradient cards, emoji icons, colored pills, uppercase headings, blue defaults); mandatory discovery phase before writing UI code; craft-level patterns for dashboards, landing pages, tables, charts; review checklist for accessibility, contrast, motion safety; calibrated easing, shadows, spacing, and border-radius rules. Load when: editing .tsx/.vue/.svelte/.jsx/.css/.scss in components/, pages/, app/, views/, layouts/; building UI components, pages, screens; adding animations or transitions; reviewing or polishing interfaces; working with design tokens, theming, dark mode; implementing dashboards, tables, or landing pages. Triggers: UI, component, page, screen, layout, dashboard, card, modal, sidebar, navbar, form, button, table, animation, hover, design system, theme, dark mode, responsive, a11y, polish, typography, spacing, color, shadow, easing, motion."
